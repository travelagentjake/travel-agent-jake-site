...
<section class="theme-light" style="padding-top:36px;">
  <div class="wrap">
    <div class="jake-card" style="max-width:900px; margin:0 auto;">
      <div class="accom-category">Passo Tonale, Italy</div><span class="resort-favourite-badge">&#9733; Jake's favourite</span>
      <div class="photo-carousel" data-carousel>
        <div class="photo-carousel-track">
          <img src="https://images.unsplash.com/photo-1550503736-c1a2c9033c03?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Alpine village houses in the snow at Passo Tonale" loading="lazy">
          <img src="https://images.unsplash.com/photo-1776763019060-fa0663574ae6?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Indoor hotel swimming pool" loading="lazy">
          <img src="https://images.unsplash.com/photo-1758632031161-b6d7e913c2b9?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Wellness sauna at the hotel" loading="lazy">
          <img src="https://images.unsplash.com/photo-1743794260306-7cb91fa83c62?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Cosy dining room with mountain-lodge styling" loading="lazy">
        </div>
        <button class="photo-carousel-arrow photo-carousel-prev" type="button" aria-label="Previous photo">&lsaquo;</button>
        <button class="photo-carousel-arrow photo-carousel-next" type="button" aria-label="Next photo">&rsaquo;</button>
        <div class="photo-carousel-dots"></div>
      </div>
...
<section class="theme-light" style="padding-top:0;">
  <div class="wrap">
    <div class="jake-card" style="max-width:900px; margin:0 auto;">
      ...
      <div class="photo-carousel" data-carousel>
        <div class="photo-carousel-track">
          <img src="https://images.unsplash.com/photo-1710148448216-e4ee423d24f7?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Snowy ski lift on the mountain above Soldeu" loading="lazy">
          <img src="https://images.unsplash.com/photo-1649794759593-ad80231b7b7c?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Gondola climbing a snowy mountainside" loading="lazy">
          <img src="https://images.unsplash.com/photo-1776763255373-80346a458ed6?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Indoor hotel spa pool" loading="lazy">
          <img src="https://images.unsplash.com/photo-1701527318649-3dab97f88226?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Hotel bedroom with a balcony" loading="lazy">
        </div>
        <button class="photo-carousel-arrow photo-carousel-prev" type="button" aria-label="Previous photo">&lsaquo;</button>
        <button class="photo-carousel-arrow photo-carousel-next" type="button" aria-label="Next photo">&rsaquo;</button>
        <div class="photo-carousel-dots"></div>
...
<section class="theme-light" style="padding-top:0;">
  <div class="wrap">
    <div class="jake-card" style="max-width:900px; margin:0 auto;">
      ...
      <div class="photo-carousel" data-carousel>
        <div class="photo-carousel-track">
          <img src="https://images.unsplash.com/photo-1465220183275-1faa863377e3?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Snowy alpine mountains above a Tyrolean valley" loading="lazy">
          <img src="https://images.unsplash.com/photo-1544817535-d78eb64ab222?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Tyrolean village houses near the mountains" loading="lazy">
          <img src="https://images.unsplash.com/photo-1776763255370-544f0a293bc7?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Indoor hotel pool with wooden accents" loading="lazy">
          <img src="https://images.unsplash.com/photo-1743794260156-a9bc22c570f7?auto=format&amp;fit=crop&amp;w=1200&amp;q=80" alt="Wood-panelled mountain lodge dining area" loading="lazy">
        </div>
        <button class="photo-carousel-arrow photo-carousel-prev" type="button" aria-label="Previous photo">&lsaquo;</button>
        <button class="photo-carousel-arrow photo-carousel-next" type="button" aria-label="Next photo">&rsaquo;</button>
        <div class="photo-carousel-dots"></div>
...
(function(){
  document.querySelectorAll('[data-carousel]').forEach(function(car){
    var track = car.querySelector('.photo-carousel-track');
    if (!track) return;
    var imgs = track.querySelectorAll('img');
    if (!imgs.length) return;
    var prev = car.querySelector('.photo-carousel-prev');
    var next = car.querySelector('.photo-carousel-next');
    var dotsWrap = car.querySelector('.photo-carousel-dots');
    ...
    var dots = dotsWrap.querySelectorAll('.photo-carousel-dot');
    ...
    if (prev) prev.addEventListener('click', function(){
      track.scrollTo({left: track.scrollLeft - track.offsetWidth, behavior: 'smooth'});
    });
...
<section class="theme-light" style="padding-top:0;">
  <div class="wrap">
    ...
    <div class="jake-card" style="max-width:760px; margin:16px auto 0;">
      <h3 style="font-size:17px;">I'd be coming on my own, am I stuck paying a solo supplement?</h3>
      <p>You can only share a room with someone else if you're both on the same booking, so if you know another first-timer who fancies it, get them booked on with you. Travelling solo is no problem either, just message me and I'll talk you through what a single room adds to the price.</p>
    </div>
    <div class="jake-card" style="max-width:760px; margin:16px auto 0;">
      <h3 style="font-size:17px;">A few of us want to book together, is there a group discount?</h3>
      <p>You can all book on together with no issue, but the per person price is the same whether it's just you or a group of six, there's no group discount built into Slope Starters.</p>
    </div>
    <div class="jake-card" style="max-width:760px; margin:16px auto 0;">
      <h3 style="font-size:17px;">Will I be learning with total strangers all week?</h3>
      <p>You'll be split into a small ski school group on your first morning, and the instructors do their best to keep anyone who booked together in the same group. So if you're coming with someone, you should be learning side by side.</p>
    </div>
    <div class="jake-card" style="max-width:760px; margin:16px auto 0;">
      <h3 style="font-size:17px;">What about lunch, is that included too?</h3>
      <p>Breakfast and your evening meal are included every day, but lunch on the mountain isn't. There's normally plenty of cafes and mountain restaurants to grab something between runs, just worth carrying a bit of cash as not everywhere takes card.</p>
    </div>
    <div class="jake-card" style="max-width:760px; margin:16px auto 0;">
      <h3 style="font-size:17px;">Can I bring the kids on Slope Starters?</h3>
      <p>Yes, children can join, though ski and snowboard school have minimum ages that vary by resort: 4+ for skiing or 8+ for snowboarding in Passo Tonale, 6+ for either in Soldeu, and 5+ for skiing or 10+ for snowboarding in St Johann in Tyrol. Message me with ages and I'll confirm what works for your family.</p>
    </div>
    <div class="jake-card" style="max-width:760px; margin:16px auto 0;">
      <h3 style="font-size:17px;">Is this covered if something goes wrong?</h3>
      <p>Yes. These are Crystal Ski Holidays packages, ATOL protected under TUI UK Limited (ATOL 2524, ABTA V5126), and I book them on your behalf as your travel agent. You'll get an ATOL Certificate once you've paid, always check everything you've booked is listed on it. Full terms are in <a href="https://www.crystalski.co.uk/our-policies/terms-and-conditions/" target="_blank" rel="noopener">Crystal Ski Holidays' own booking conditions</a>.</p>
    </div>
  </div>
</section>
...
<section class="theme-bold">
  <div class="wrap" style="text-align:center;">
    ...
    <p style="max-width:70ch; margin:22px auto 0; text-align:center; font-size:13px; opacity:0.75;">Prices shown are per person based on two adults sharing and correct as of ::TODAY::, subject to change and availability. These are Crystal Ski Holidays packages, a trading name of TUI UK Limited (ATOL 2524, ABTA V5126), booked through Travel Agent Jake acting as your agent. See <a class="body-copy" href="https://www.crystalski.co.uk/our-policies/terms-and-conditions/" target="_blank" rel="noopener">Crystal Ski Holidays' booking conditions</a> for full terms.</p>
  </div>
</section>
"""
